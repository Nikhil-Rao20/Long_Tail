"""
Test-Time Augmentation (TTA) for CXR Classification

TTA applies multiple augmentations at inference time and aggregates predictions.
This can improve performance by 0.5-2% mAP without any retraining.

Augmentations suitable for CXR:
- Horizontal flip (lungs are roughly symmetric)
- Minor rotations (±5-10 degrees)
- Scale variations (±10%)
- Brightness/contrast adjustments

NOT recommended for CXR:
- Vertical flip (anatomically incorrect)
- Large rotations (>15 degrees)
- Color jittering (grayscale images)
"""
...
class TTAPredictor:
    ...
    def __init__(
        ...
        Args:
            ...
            merge_mode: How to merge predictions ("mean", "max", "gmean", "median")
...
def tta_predict(
    ...
    Args:
        ...
        merge_mode: How to merge predictions ("mean", "max", "gmean")
